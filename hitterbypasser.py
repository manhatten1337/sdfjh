	...
	if req.path.split("://", 1)[1].startswith("api.stripe.com"):
		try:
			if b"payment_method_data[card][number]" in req_body:
				...
				# Delete "payment_method_data[payment_user_agent]" and "payment_method_data[card][cvc]" from parsedbody
				...
				# Delete "payment_method_data[pasted_fields]" and "payment_method_data[time_on_page]" from parsedbody
				...
				# Delete "payment_user_agent" and "card[cvc]" from parsedbody
				parsedbody = deletefromarray(parsedbody, "payment_user_agent")
				parsedbody = deletefromarray(parsedbody, "card[cvc]")

				# Delete "pasted_fields" and "time_on_page" from parsedbody
				...
				# Delete "source_data[payment_user_agent]" and "source_data[card][cvc]" from parsedbody
				...
				# Delete "source_data[pasted_fields]" and "source_data[time_on_page]" from parsedbody
